...
-------------------------------------------------------------------------------
### Bugs
  * Live doesn't work with TextBox, TextArea
  * Change event in CheckBox doesn't send control
  * Add examples

      oj/examples/client-side-hello-world

      oj/examples/client-side-with-backbone

      oj/examples/server-side-command-line

      oj/examples/server-side-express (NYI)

  * Consider use `extend` for plugin "use"

    * look at express middleware as example

  * Consider `globalize` or `oj.makeGlobal()`
