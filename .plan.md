...
* Consider renaming all events to prefix with did/will, or on

* ocNative modules don't work (and break everything)

* Add object construction to ojml
...
* Add oj.min.js building to cake build, so before publishing I can show this stuff off.
