...
(function() {
  ...
  compileFile = function(filePath, includeDir, options, cb) {
    var cache, cacheLength, deltaTime, dirOut, eCompile, eRequire, fileBaseName, fileDir, fileOut, hookCache, hookOriginalCache, html, includedModules, isDebug, isMinify, mediaMap, moduleLinkMap, moduleParents, modules, ojml, outputDir, plugin, results, rootDir, scriptHtml, scriptIndex, startTime, styleHTML, styleIndex, subDir, timeStamp, _j, _len1, _ref1, _ref2, _ref3;
