...
(function() {
  ...
  compileFile = function(filePath, includeDir, options, cb) {
    var cache, cacheLength, cssMap, deltaTime, dirOut, eCSS, eCompile, eRequire, fileBaseName, fileDir, fileOut, hookCache, hookOriginalCache, html, includedModules, isDebug, isMinify, moduleLinkMap, moduleParents, modules, ojml, outputDir, results, rootDir, scriptHtml, scriptIndex, startTime, styleHtml, styleIndex, subDir, timeStamp, _j, _len1, _ref1, _ref2;
  ...
  _minifyAndWrapCSSInStyleTags = function(cssMap, filePath, isDebug, structureOff) {
    var css_, newline;

    css_ = minifyCSSUnless(isDebug, filePath, cssMap, {
      structure: structureOff
    });
    newline = isDebug ? '\n' : '';
