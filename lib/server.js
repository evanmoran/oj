...
(function() {
  ...
  compileFile = function(filePath, includeDir, options, cb) {
    var cache, cacheLength, css, deltaTime, dirOut, eCSS, eCompile, eRequire, fileBaseName, fileDir, fileOut, hookCache, hookOriginalCache, html, includedModules, isDebug, moduleLinkMap, moduleParents, modules, ojml, outputDir, results, rootDir, scriptHtml, scriptIndex, startTime, styleHtml, styleIndex, subDir, timeStamp, _j, _len1;
