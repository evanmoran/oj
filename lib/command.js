...
(function() {
  ...
  compile = function(filePath, options) {
    var cache, cacheLength, fileClient, fileOut, html, m, modules, ojml, outputDir, scriptHtml, _i, _len, _ref;
    if (options == null) {
      options = {};
    }
  ...
  _requireCacheToString = function(cache, clientFilePath, isDebug) {
    var code, filePath, moduleDir, moduleName, nameToMain, _compiledFile, _fileToString, _files, _find, _modules, _modulesToString, _native, _nativeModuleToString, _ref, _ref1, _ref2, _run;
