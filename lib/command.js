...
(function() {
  ...
  module.exports = function() {
    ...
    commander.version('0.0.3').usage('[options] <file, ...>').option('-v, --verbose', 'Turn on verbose output (default: off)').option('-o, --output <dir>', 'Directory to output all files to (default: .)', process.cwd()).option('    --css <dir>', 'Directory to output css files to (default: .)').option('    --js <dir>', 'Directory to output js files to (default: .)').option('    --html <dir>', 'Directory to output css files to (default: .)').option('-r, --recurse', 'Recurse into directories (default: off)', false).option('-w, --watch <dir,dir,...>', 'Directories to watch (default: off)', trimArgList).parse(process.argv);
  ...
  compile = function(files, options) {
    ...
    return console.log("compile called: ", options);
  };
