...
(function() {
  ...
  oj.compile = function(options, ojml) {
    var acc, css, cssMap, dom, html, out, pluginCSSMap, styles;
    ...
    acc.css = options.css || options.cssMap || options.styles ? {} : null;
    acc.indent = '';
    if (options.dom) {
      acc.types = [];
    }
    ...
    if (options.styles) {
      styles = _cssFromPluginObject(pluginCSSMap, {
        debug: options.debug,
        tags: 1
      });
    }
  ...
  _cssFromMediaObject = function(mediaMap, options) {
    var css, debug, indent, indentRule, inline, media, minify, newline, rules, selector, selectorMap, space, styles, tags, _ref2, _ref3, _ref4;

    if (options == null) {
      options = {};
    }
    debug = (_ref2 = options.debug) != null ? _ref2 : 0;
    tags = (_ref3 = options.tags) != null ? _ref3 : 0;
    minify = (_ref4 = options.minify) != null ? _ref4 : 0;
    newline = debug ? '\n' : '';
    space = debug ? ' ' : '';
    inline = !debug;
    css = '';
    ...
    return oj._minifyCSS(css, options);
  };

  _cssFromPluginObject = function(flatCSSMap, options) {
    var css, debug, inline, mediaMap, minify, newline, plugin, space, tags, _ref2, _ref3, _ref4;
  ...
  oj.View = oj.createType('View', {
    ...
    methods: {
      ...
      toCSS: function(debug) {
        return _cssFromPluginObject(_flattenCSSMap(this.cssMap), {
          debug: debug,
          tags: 0
        });
      },
  ...
  oj.View.css = function(def) {
    var cssMap, _base, _name, _ref2;

    cssMap = _setObject({}, ".oj-" + this.typeName, def);
  ...
  oj.View.theme = function(name, def) {
    ...
    cssMap = _setObject({}, ".oj-" + this.typeName + ".theme-" + dashName, def);
    _extend(this.cssMap["oj-" + this.typeName], cssMap);
