...
(function() {
  var ArrayP, FuncP, ObjP, coffee, compileJS, concat, dhp, doctypes, exports, jqName, jqueryEvents, key, oj, ojName, pass, pathNormalizeArray, pathSplit, pathSplitRe, plugins, root, slice, strict4, strict5, stripBOM, t, unshift, w3, wrapCSMessage, wrapJS, wrapJSMessage, _, _argumentsStack, _attributeCMeansClass, _attributeClassAllowsArrays, _attributeOmitFalsyValues, _attributeStyleAllowsObject, _attributesBindEventsToDOM, _attributesFilterOutEvents, _attributesFromObject, _attributesProcessedForOJ, _boundOrThrow, _breaker, _chars, _clone, _compileAny, _compileDeeper, _compileTag, _contains, _cssFromObject, _defaults, _each, _extend, _flatten, _flattenCSSMap, _flattenCSSMap_, _fn, _fn1, _getInstanceOnElement, _getTagName, _has, _i, _identity, _indexOf, _inherit, _isCapitalLetter, _isEmpty, _j, _jqGetValue, _jqueryExtend, _keys, _len, _len1, _omit, _randomInteger, _readyOrLoad, _readyQueue, _reduce, _ref, _ref1, _ref2, _setInstanceOnElement, _setObject, _setTagName, _some, _sortedIndex, _splitAndTrim, _styleFromObject, _styleKeyFromCamalCase, _toArray, _uniqueSort, _uniqueSortedUnion, _values,
    __slice = [].slice;
  ...
  oj._argumentsTop = function() {
    if (_argumentsStack.length) {
      return _argumentsStack[_argumentsStack.length - 1];
    } else {
      return null;
    }
  };

  oj._argumentsPush = function(args) {
    if (args == null) {
      args = [];
    }
  ...
  oj._argumentsAppend = function(arg) {
    var top;
  ...
  oj.tag = function() {
    ...
    for (_j = 0, _len1 = args.length; _j < _len1; _j++) {
      ...
      if (oj.isObject(arg)) {
        ...
        r = arg();
        if (len === oj._argumentsTop().length && (r != null)) {
  ...
  _styleKeyFromCamalCase = function(key) {
    var c, out, _j, _len1;
  ...
  _flattenCSSMap_ = function(cssMap, flatMapAcc, selectorsAcc, mediasAcc) {
  ...
  _cssFromObject = function(cssMap, debug) {
    var css, flatMap, indent, indentRule, inline, media, newline, rules, selector, selectorMap, space, styles;
    ...
    css = '';
    for (media in flatMap) {
      selectorMap = flatMap[media];
      if (media) {
      ...
      for (selector in selectorMap) {
        ...
        indentRule = debug ? indent + '\t' : indent;
      ...
      default:
        if (oj.isOJ(ojml)) {
          ...
          if ((_ref12 = options.html) != null) {
            _ref12.push(ojml.toHTML());
          }
          if ((_ref13 = options.dom) != null) {
            _ref13.appendChild(ojml.toDOM());
          }
          if (options.css != null) {
  ...
  _compileTag = function(ojml, options) {
    var att, attr, attrName, attrValue, attributes, child, children, el, events, selector, space, styles, tag, tagType, _base, _j, _k, _len1, _len2, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    ...
    if (options.css && tag === 'css') {
      for (selector in attributes) {
        ...
        if ((_ref2 = (_base = options.css)[selector]) == null) {
    ...
    if (!options.ignore[tag]) {
      ...
      if (options.html) {
        attr = (_ref4 = _attributesFromObject(attributes)) != null ? _ref4 : '';
        space = attr === '' ? '' : ' ';
    ...
    properties: {
        ...
        set: function(v) {
          ...
          if (oj.isDOMElement(v)) {
            ...
            _ref2 = oj.compile({
              ...
              dom: 1,
              html: 0
            }, v), this._el = _ref2.dom, this.cssMap = _ref2.cssMap;
          }
        }
      },
      $el: {
      ...
      cssMap: {
        get: function() {
          ...
          return (_ref2 = this._cssMap) != null ? _ref2 : {};
        },
        set: function(v) {
  ...
  oj.TextBox = oj.type('TextBox', {
    ...
    constructor: function() {
      ...
      _ref2 = oj.argumentsUnion(arguments), options = _ref2.options, args = _ref2.args;
      this.el = oj(function() {
        return oj.input({
          type: 'text'
        }, {
  ...
  oj.Button = oj.type('Button', {
    ...
    constructor: function(args) {
      var options, _ref2, _ref3,
        _this = this;

      _ref2 = oj.argumentsUnion(arguments), options = _ref2.options, args = _ref2.args;
      if ((_ref3 = options.label) == null) {
    ...
    methods: {
      ...
      make: function() {
        ...
        if ((this.models != null) && (this.each != null)) {
          models = oj.isEvent(this._models) ? this._models.models : this._models;
  ...
  oj.Table = oj.type('Table', {
    base: oj.CollectionView,
    constructor: function() {
      var arg, args, options, rows, _j, _len1, _ref2, _ref3,
        _this = this;
      ...
      rows = args;
      return this.rows = options.rows != null ? oj.argumentShift(options, 'rows') : rows;
    },
    properties: {
      rowCount: {
        get: function() {
      ...
      columnCount: {
        get: function() {
          ...
          return (_ref2 = (_ref3 = (_ref4 = this.$tr(0).find('> td').length) != null ? _ref4 : this.$theadTR.find('> th').length) != null ? _ref3 : this.$tfootTR.find('> td').length) != null ? _ref2 : 0;
        }
      },
      rows: {
        get: function() {
    ...
    methods: {
      make: function() {
        var model, models, rowViews, _j, _len1,
          _this = this;
        ...
        this.$tbodyMake.oj(function() {
          var r, _k, _len2, _results;

          _results = [];
          for (_k = 0, _len2 = rowViews.length; _k < _len2; _k++) {
            r = rowViews[_k];
            _results.push(oj.tr(function() {
              var c, _l, _len3, _results1;

              _results1 = [];
              for (_l = 0, _len3 = r.length; _l < _len3; _l++) {
                c = r[_l];
                _results1.push(oj.td(c));
              }
              return _results1;
            }));
          }
        ...
        console.log("@toHTML(): ", this.toHTML());
        this.bodyChanged();
      },
      collectionAdded: function(m, c) {
        var row, rx;
      ...
      $tr: function(rx) {
        rx = this._bound(rx, this.rowCount, ".$tr: rx");
        return this.$trs.eq(rx);
      },
      $tdsRow: function(rx) {
        rx = this._bound(rx, this.rowCount, ".$tdsRow: rx");
        return this.$tr(rx).find('> td');
      },
      $tdsColumn: function(cx) {
        var rx;
      ...
      $td: function(rx, cx) {
        rx = this._bound(rx, this.rowCount, ".$td: rx");
        cx = this._bound(cx, this.cellCount(rx), ".$td: cx");
        return this.$tdsRow.eq(cx);
      },
      ...
      column: function(cx, listOJML) {
        return cx = this._bound(cx, this.columnCount, ".column: cx");
      },
      ...
      addRow: function(rx, listOJML) {
        ...
        if (this.rowCount === 0) {
          this.$el.oj(function() {
            return oj[tag](listOJML);
          });
        } else if (rx === this.rowCount) {
          this.$tr(rx - 1).ojAfter(function() {
            return oj[tag](listOJML);
          });
        } else {
          this.$tr(rx).ojBefore(function() {
            return oj[tag](listOJML);
          });
        }
        this.bodyChanged();
      ...
      moveRow: function(rxFrom, rxTo) {
        ...
        if (rxTo > rxFrom) {
          this.$tr(rxFrom).insertAfter(this.$tr(rxTo));
        } else {
          this.$tr(rxFrom).insertBefore(this.$tr(rxTo));
        }
        this.bodyChanged();
      },
      swapRow: function(ix1, ix2) {
        var ixMax, ixMin;

        if (ix1 === ix2) {
          return;
        }
        ix1 = this._bound(ix1, this.rowCount, ".swap: firstIndex");
        ix2 = this._bound(ix2, this.rowCount, ".swap: secondIndex");
        if (Math.abs(ix1 - ix2) === 1) {
          this.move(ix1, ix2);
        } else {
          ixMin = Math.min(ix1, ix2);
  ...
  jQuery.fn.oj = _jqueryExtend({
    set: function($el, args) {
      var d, dom, types, _k, _l, _len2, _len3, _ref3;
      ...
      _ref3 = oj.compile.apply(oj, [{
        ...
        html: 0,
        css: 0
      }].concat(__slice.call(args))), dom = _ref3.dom, types = _ref3.types;
      $el.html('');
      if (!oj.isArray(dom)) {
        dom = [dom];
      }
