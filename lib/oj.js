...
(function() {
  ...
  _cssFromMediaObject = function(mediaMap, options) {
    var css, debug, eCSS, indent, indentRule, inline, media, minify, newline, rules, selector, selectorMap, space, styles, tags, _ref2;

    if (options == null) {
      options = {};
    }
    debug = 0;
    tags = (_ref2 = options.tags) != null ? _ref2 : 0;
    minify = 1;
    newline = debug ? '\n' : '';
    space = debug ? ' ' : '';
    inline = !debug;
