...
(function() {
  ...
  _getInstanceOnElement = function(el) {
    if ((el != null ? el.ojInstance : void 0) != null) {
      return el.ojInstance;
    } else {
      return null;
    }
  };
  ...
  oj.View = oj.type('View', {
    constructor: function(args) {
      ...
      emit = (_ref1 = oj.argumentShift(args, 'emit')) != null ? _ref1 : true;
      if (emit) {
        this.emit();
      }
      if ((_ref2 = args.id) == null) {
        args.id = oj.id();
      }
  ...
  oj.List = oj.type('List', {
    ...
    constructor: function() {
      var args, items, options, tag, _ref1, _ref2,
        _this = this;
      _ref1 = oj.argumentsUnion(arguments), options = _ref1.options, args = _ref1.args;
      this._ordered = oj.argumentShift(args, 'ordered');
      tag = oj.argumentShift(args, 'tagName');
      this._tagName = oj.isObject(tag) ? _getTagName(tag) : tag;
      this.itemTagName = oj.argumentShift(args, 'itemTagName');
      ...
      if (options.items != null) {
        this.items = items = oj.argumentShift(options, 'items');
      }
    ...
    properties: {
      ordered: {
        get: function() {
          return this._ordered || this.tagName === 'ol';
        }
      },
      tagName: {
        get: function() {
        ...
        if ((this.models != null) && (this.each != null)) {
          ...
          return this.$el.oj(function() {
            ...
            for (_j = 0, _len1 = models.length; _j < _len1; _j++) {
              model = models[_j];
              _results.push(_this.each(model, oj[_this.itemTagName]));
            }
            return _results;
          });
