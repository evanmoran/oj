...
(function() {
  var ArrayP, FuncP, ObjP, coffee, compileJS, concat, dhp, doctypes, exports, jqName, jqueryEvents, jqueryExtend, key, oj, ojName, pass, pathNormalizeArray, pathSplit, pathSplitRe, plugins, root, slice, strict4, strict5, stripBOM, t, unshift, w3, wrapCSMessage, wrapJS, wrapJSMessage, _, _attributeCMeansClass, _attributeClassAllowsArrays, _attributeOmitFalsyValues, _attributeStyleAllowsObject, _attributesBindEventsToDOM, _attributesFilterOutEvents, _attributesFromObject, _attributesProcessedForOJ, _boundOrThrow, _chars, _compileAny, _compileDeeper, _compileTag, _cssFromObject, _defaultClear, _fn, _fn1, _getInstanceOnElement, _getTagName, _i, _j, _len, _len1, _randomInteger, _readyOrLoad, _readyQueue, _ref, _ref1, _ref2, _setInstanceOnElement, _setTagName, _styleFromObject, _styleKeyFromFancy, _upgradeTagMethod,
    __slice = [].slice;
  ...
  _upgradeTagMethod = function(name, attributes) {
    var attr;
