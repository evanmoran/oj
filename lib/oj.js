...
(function() {
  ...
  _compileTag = function(ojml, options) {
    var att, attr, attrName, attrValue, attributes, child, children, el, events, selector, space, styles, tag, tagType, _base, _j, _k, _len1, _len2, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    if (ojml.length === 0) {
      return;
    }
    tag = ojml[0];
        ...
        set: function(v) {
          ...
          if (oj.isDOMElement(v)) {
            ...
            _ref1 = oj.compile({
              ...
              dom: 1,
              html: 0
            }, v), this._el = _ref1.dom, this.cssMap = _ref1.cssMap;
          }
        }
      },
      $el: {
