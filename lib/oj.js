...
(function() {
  var ArrayP, F, FuncP, ObjP, coffee, events, exports, fs, isCS, isJS, oj, root, slice, stripBOM, t, unshift, _, _chars, _compileAny, _compileDeeper, _compileTag, _defaultClear, _fn, _i, _len, _load, _loader, _loaderQueue, _randomInteger, _ref, _styleFromObject, _styleKeyFromFancy, _tagAttributes,
    __slice = [].slice;
  ...
  _compileTag = function(ojml, options) {
    var attr, attributes, child, children, k, tag, v, _fn1, _j, _k, _len1, _len2, _ref1, _ref2, _ref3, _ref4, _ref5;
    tag = ojml[0];
