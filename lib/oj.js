...
(function() {
  var ArrayP, F, FuncP, ObjP, coffee, exports, fs, isCS, isJS, jqueryEvents, oj, pass, root, slice, stripBOM, t, unshift, _, _attributeCMeansClass, _attributeClassAllowsArrays, _attributeStyleAllowsObject, _attributesFilterOutEvents, _attributesFromObject, _chars, _compileAny, _compileDeeper, _compileElement, _compileOJInstance, _compileTag, _cssFromObject, _defaultClear, _fn, _i, _len, _randomInteger, _readyOrLoad, _readyQueue, _ref, _styleFromObject, _styleKeyFromFancy, _tagAttributes,
    __slice = [].slice;
  ...
  _compileOJInstance = function(ojml, options) {
    if (options.html) {
  ...
  _compileElement = function(ojml, options) {
    if (options.html) {
  ...
  _compileTag = function(ojml, options) {
    var attr, attrName, attrValue, attributes, child, children, ek, el, ev, events, selector, space, styles, tag, _base, _j, _k, _len1, _len2, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    tag = ojml[0];
  ...
  oj.View = oj.type('View', {
    ...
    */
    ...
    constructor: function() {
      ...
      _ref1 = _.optionsUnion(arguments), options = _ref1.options, args = _ref1.args;
      ...
      el: {
        get: function() {
          ...
          if (typeof document !== "undefined" && document !== null) {
            this._el = document.getElementsById(this._id);
            if (oj.isDOMElement(this._el)) {
              return this._el;
            }
          }
