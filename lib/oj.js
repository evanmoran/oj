...
(function() {
  ...
  oj.compile = function(options, ojml) {
    var acc, css, cssMap, dom, flatCSSMap, html, out, styles;
    ...
    if (options.css) {
      css = _cssFromObject(flatCSSMap, {
        debug: options.debug,
        tags: 0
      });
    }
    if (options.styles) {
      styles = _cssFromObject(flatCSSMap, {
        debug: options.debug,
        tags: 1
      });
    }
  ...
  _cssFromObject = function(flatCSSMap, options) {
    var css, debug, indent, indentRule, inline, media, mediaMap, newline, plugin, rules, selector, selectorMap, space, styles, tags, _ref2, _ref3;
  ...
  oj.View = oj.createType('View', {
    ...
    methods: {
      ...
      toCSS: function(debug) {
        return _cssFromObject(_flattenCSSMap(this.cssMap), {
          debug: debug,
          tags: 0
        });
      },
