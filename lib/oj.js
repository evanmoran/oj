...
(function() {
  ...
  _cssFromObject = function(cssMap, debug) {
    var css, flatMap, indent, indentRule, inline, media, mediaMap, newline, plugin, rules, selector, selectorMap, space, styles;
    ...
    css = '';
    for (plugin in flatMap) {
      mediaMap = flatMap[plugin];
