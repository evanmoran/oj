...
(function() {
  var ArrayP, FuncP, ObjP, coffee, concat, exports, fs, jqueryEvents, key, oj, pass, pathNormalizeArray, pathSplit, pathSplitRe, root, slice, stripBOM, t, unshift, wrapCSMessage, wrapJS, wrapJSMessage, _, _attributeCMeansClass, _attributeClassAllowsArrays, _attributeStyleAllowsObject, _attributesFilterOutEvents, _attributesFromObject, _attributesProcessedForOJ, _chars, _compileAny, _compileDeeper, _compileTag, _cssFromObject, _defaultClear, _fn, _i, _j, _len, _len1, _randomInteger, _readyOrLoad, _readyQueue, _ref, _ref1, _styleFromObject, _styleKeyFromFancy, _tagAttributes,
    __slice = [].slice;
  ...
  */
  ...
  oj.ModelKeyView = oj.type('ModelKeyView', {
    ...
    constructor: function(args) {
      ...
      oj.ModelKeyView.base.constructor.apply(this, [args_]);
    ...
    properties: {
      ...
      value: {
        get: function() {
          throw "" + this.type + ".value get needs override";
        },
        set: function(v) {
          throw "" + this.type + ".value set needs override";
        }
      },
      live: {
        get: function() {
