...
(function() {
  var ArrayP, F, FuncP, ObjP, coffee, events, exports, fs, isCS, isJS, oj, root, slice, stripBOM, t, unshift, _, _chars, _compileAny, _compileDeeper, _compileTag, _cssFromObject, _defaultClear, _fn, _i, _len, _randomInteger, _readyOrLoad, _readyQueue, _ref, _styleFromObject, _styleKeyFromFancy, _tagAttributes,
    __slice = [].slice;

  oj = module.exports = function(ojml) {
    return oj.toDOM(ojml);
  };

  oj.oj = oj;

  oj.begin = module.exports = function(page) {
    return _readyOrLoad(function() {
      var compiled, doc, html;
  ...
  if (require.extensions) {
    ...
    require.extensions['.oj'] = function(module, filepath) {
      var code, _ref, _ref1, _ref2, _ref3;
      ...
      try {
        ...
        eCoffee.message = "" + ((_ref = oj.codes) != null ? _ref.red : void 0) + "coffee-script error in " + filepath + ": " + eCoffee.message + ((_ref1 = oj.codes) != null ? _ref1.reset : void 0);
        if ((isCS(code)) || !(isJS(code))) {
          throw eCoffee;
        }
      }
      try {
        ...
        eJS.message = "" + ((_ref2 = oj.codes) != null ? _ref2.red : void 0) + "javascript error in " + filepath + ": " + eJS.message + ((_ref3 = oj.codes) != null ? _ref3.reset : void 0);
        throw eJS;
      }
    };
  }
  ...
  _styleFromObject = function(obj, options) {
    ...
    indent = options.debug && !options.inline ? '\t' : '';
    newline = options.debug && !options.inline ? '\n' : '';
  ...
  _cssFromObject = function(cssMap, debug) {
    var css, inline, newline, rules, selector, space, styles;
    if (debug == null) {
      debug = false;
    }
    newline = debug ? '\n' : '';
  ...
  _compileTag = function(ojml, options) {
    var attr, attributes, child, children, k, selector, styles, tag, v, _base, _fn1, _j, _k, _len1, _len2, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    tag = ojml[0];
    ...
    if (tag === 'css') {
      ...
      if (attributes) {
        _fn1 = function(k, v) {
          var _ref2, _ref3;
          if (events[k] != null) {
            if ((_ref2 = attributes.id) == null) {
              attributes.id = oj.id();
            }
            if (typeof $ !== "undefined" && $ !== null) {
              if ((_ref3 = options.js) != null) {
                _ref3.push(function() {
                  var $el;
                  $el = $('#' + attributes.id);
                  if (_.isArray(v)) {
  ...
  oj.type = function(name, args) {
    var Out, methodKeys, methods, propKeys, properties, typeProps, _ref1, _ref2, _ref3, _ref4;
    if (args == null) {
      args = {};
    }
    if (!_.isString(name)) {
  ...
  oj.View = oj.type('View', {
    ...
    properties: {
      ...
      css: {
        get: function() {
          throw 'css getter nyi';
        },
        set: function() {
          throw 'css setter nyi';
        }
      },
      style: {
        get: function() {
          throw 'style getter nyi';
        },
        set: function() {
          throw 'style setter nyi';
        }
      }
    },
    methods: {
  ...
  oj.Checkbox = oj.type('Checkbox', {
    ...
    methods: {
      ...
      toString: function() {
        return this["super"].toString.apply(this, arguments);
      }
    }
  });
