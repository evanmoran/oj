...
(function() {
  var ArrayP, FuncP, ObjP, concat, dhp, exports, jqName, jqueryEvents, key, oj, ojName, pass, plugins, root, slice, strict4, strict5, t, unshift, w3, _argumentsStack, _attributeCMeansClassAndAllowsArrays, _attributeOmitFalsyValues, _attributeStyleAllowsObject, _attributesBindEventsToDOM, _attributesFilterOutEvents, _attributesFromObject, _attributesProcessedForOJ, _boundOrThrow, _breaker, _chars, _clone, _compileAny, _compileDeeper, _compileTag, _contains, _cssFromMediaObject, _cssFromPluginObject, _dasherize, _decamelize, _defaults, _doctypes, _each, _extend, _flatten, _flattenCSSMap, _flattenCSSMap_, _fn, _fn1, _getInstanceOnElement, _getTagName, _has, _i, _identity, _indexOf, _inherit, _isCapitalLetter, _isEmpty, _j, _jqGetValue, _jqueryExtend, _keys, _len, _len1, _omit, _onLoadQueue, _pathNormalizeArray, _pathSplit, _pathSplitRe, _randomInteger, _reduce, _ref, _ref1, _ref2, _setInstanceOnElement, _setObject, _setTagName, _some, _sortedIndex, _splitAndTrim, _styleFromObject, _toArray, _uniqueSort, _uniqueSortedUnion, _values,
    __slice = [].slice;
  ...
  oj.load = function(page) {
    return jQuery(function() {
      var body, bodyOnly, d, dom, eCompile, t, types, _i, _j, _len, _len1, _ref1;
      ...
      try {
        _ref1 = oj.compile({
          ...
          styles: 1,
          ignore: bodyOnly
        }, require(page)), dom = _ref1.dom, types = _ref1.types;
      } catch (_error) {
        eCompile = _error;
  ...
  _cssFromMediaObject = function(mediaMap, options) {
    var css, debug, eCSS, indent, indentRule, inline, media, minify, newline, rules, selector, selectorMap, space, styles, tags, _ref2, _ref3, _ref4;
