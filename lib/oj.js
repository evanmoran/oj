...
(function() {
  var ArrayP, FuncP, ObjP, coffee, compileJS, concat, dhp, doctypes, exports, jqName, jqueryEvents, jqueryExtend, key, oj, ojName, pass, pathNormalizeArray, pathSplit, pathSplitRe, plugins, root, slice, strict4, strict5, stripBOM, t, unshift, w3, wrapCSMessage, wrapJS, wrapJSMessage, _, _argumentsStack, _attributeCMeansClass, _attributeClassAllowsArrays, _attributeOmitFalsyValues, _attributeStyleAllowsObject, _attributesBindEventsToDOM, _attributesFilterOutEvents, _attributesFromObject, _attributesProcessedForOJ, _boundOrThrow, _chars, _clone, _compileAny, _compileDeeper, _compileTag, _contains, _cssFromObject, _defaults, _each, _extend, _flatten, _fn, _fn1, _getInstanceOnElement, _getTagName, _has, _i, _identity, _indexOf, _inherit, _isCapitalLetter, _isEmpty, _j, _keys, _len, _len1, _omit, _randomInteger, _readyOrLoad, _readyQueue, _reduce, _ref, _ref1, _ref2, _setInstanceOnElement, _setTagName, _some, _sortedIndex, _styleFromObject, _styleKeyFromFancy, _toArray, _uniqueSort, _uniqueSortedUnion, _values,
    __slice = [].slice;
  ...
  _uniqueSortedUnion = function(array, array2) {
    return _uniqueSort(array.concat(array2));
  };
  ...
  oj.NumberList = function() {
    ...
    return (_ref2 = oj.List).call.apply(_ref2, [this, {
      tagName: 'ol',
      itemTagName: 'li'
