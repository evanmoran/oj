...
(function() {
  ...
  _cssFromObject = function(cssMap, debug) {
    var css, flatCssMap, indent, inline, media, newline, rules, selector, selectorMap, space, styles;
    ...
    css = '';
    for (media in flatCssMap) {
      selectorMap = flatCssMap[media];
      if (media !== '') {
  ...
  _cssFromObject2 = function(cssMap, debug) {
  ...
  _boundOrThrow = function(ix, count, message) {
    var ixNew;
    ...
    properties: {
      ...
      $itemsEl: {
        get: function() {
          ...
          return (_ref2 = this._$itemsEl) != null ? _ref2 : (this._$itemsEl = this.$("> " + this.itemTagName));
        }
      }
    },
    methods: {
      item: function(ix, ojml) {
        ix = _boundOrThrow(ix, this.count, "oj.List.item: index");
        if (ojml != null) {
      ...
      itemEl: function(ix) {
        ix = _boundOrThrow(ix, this.count, "oj.List.itemEl: index");
      ...
      add: function(ix, ojml) {
        ...
        ix = _boundOrThrow(ix, this.count + 1, "oj.List.add: index");
      ...
      remove: function(ix) {
        ...
        ix = _boundOrThrow(ix, this.count, "oj.List.remove: index");
        out = this.item(ix);
      ...
      move: function(ixFrom, ixTo) {
        ...
        ixFrom = _boundOrThrow(ixFrom, this.count, "oj.List.move: fromIndex");
        ixTo = _boundOrThrow(ixTo, this.count, "oj.List.move: toIndex");
        if (ixTo > ixFrom) {
      ...
      swap: function(ix1, ix2) {
        ...
        ix1 = _boundOrThrow(ix1, this.count, "oj.List.swap: firstIndex");
        ix2 = _boundOrThrow(ix2, this.count, "oj.List.swap: secondIndex");
  ...
  _fn1 = function(ojName, jqName) {
    return jQuery.fn[ojName] = jqueryExtend({
      set: function($el, args) {
