...
(function() {
  ...
  _.unionArguments = function(argList) {
  ...
  oj.View = oj.type('View', {
    constructor: function() {
      var args, options, unionArguments, _ref1;
      _.argumentsAppend(this);
      unionArguments = _.unionArguments(arguments);
      options = unionArguments.options, args = unionArguments.args;
    ...
    methods: {
      make: function() {
        ...
        return oj.div({
          c: this.typeName,
          id: (_ref1 = this.id) != null ? _ref1 : oj.id()
        });
      },
      $: function() {
      ...
      model: {
        ...
        set: function(v) {
          ...
          if (oj.isBackbone(this._model)) {
            this._model.off('change', function() {
              return _this.modelChange();
            });
          }
          this._model = v;
          if (oj.isBackbone(this._model)) {
  ...
  oj.ModelKeyView = oj.type('ModelKeyView', {
    ...
    constructor: function(args) {
      ...
      this.live = !((args != null ? args.live : void 0) != null) ? true : oj.argumentShift(args, 'live');
      oj.ModelKeyView.base.constructor.apply(this, arguments);
      if ((this.model != null) && (this.key != null)) {
        return this.value = this.model.get(this.key);
      }
    },
    properties: {
      key: {
      ...
      value: {
        get: function() {
          throw "" + this.typeName + ".value get needs override";
        },
        set: function(v) {
          throw "" + this.typeName + ".value set needs override";
        }
      }
    },
    methods: {
