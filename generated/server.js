...
(function() {
  ...
  oj.command = function(options) {
    var fullPath, _j, _len1, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    ...
    if (options.all || (!options.html && !options.css && !options.js && !options.modules)) {
  ...
  lsWatch = function(paths, options, cb) {
    ...
    lsOptions = _.extend({}, {
      ...
      filterDir: function(nameWithPath) {
        return !(_startsWith(nameWithPath, options.output)) && isOJDir(nameWithPath);
      }
    });
