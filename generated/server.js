...
(function() {
  ...
  oj.command = function(options) {
    var fullPath, _j, _len1, _ref1, _ref2, _ref3;
  ...
  compileFile = function(filePath, includeDir, options, cb) {
    var cache, cacheLength, deltaTime, dirOut, eCompile, eRequire, ex, fileBaseName, fileDir, fileOut, hookCache, hookOriginalCache, html, includedModules, isMinify, mediaMap, moduleLinkMap, moduleParents, modules, ojml, outputDir, plugin, results, rootDir, scriptHtml, scriptIndex, startTime, styleHTML, styleIndex, subDir, timeStamp, _j, _k, _len1, _len2, _ref1, _ref2, _ref3, _ref4;
    ...
    styleHTML = '';
    _ref4 = results.cssMap;
    for (plugin in _ref4) {
      mediaMap = _ref4[plugin];
    ...
    if (options.write) {
      fs.writeFile(fileOut, html, function(err) {
        if (err) {
